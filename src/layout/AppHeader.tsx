  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
          ...
          <div className="flex items-center gap-2">
            <div>
              <Link to="/" className="lg:hidden">
                <img src="./images/logo/logo1.svg" alt="Logo" width={40} height={40} />
              </Link>
            </div>
            <div className="text-2xl font-medium block lg:hidden">RELI-MAINT</div>
          </div>
        ...
        {/* User area - hiển thị trên mobile khi menu mở, luôn hiển thị trên desktop */}
        <div
          className={`${
